...
func doGeoRequest(
	...
	handler, err := server.New(dashboard.WebFS(), infoSvc, systemdSvc, clientsSvc, wgSvc, fakeProcSvc(), newTestDB(t), geo, fakeDiskSvc(), fakeProcessesSvc(), fakeNetdevSvc(), nil, nil, nil, emptyClientsSvc(t), "local")
	if err != nil {
